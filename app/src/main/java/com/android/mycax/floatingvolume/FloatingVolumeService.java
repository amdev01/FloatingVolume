...
public class FloatingVolumeService extends Service implements View.OnClickListener, SeekBar.OnSeekBarChangeListener {
    ...
    private void addFloatingWidgetView(LayoutInflater inflater) {
        ...
        mFloatingWidgetView = inflater.inflate(R.layout.floating_layout, null);
        ...
        expandedView = mFloatingWidgetView.findViewById(R.id.expanded_card_view);
    }
